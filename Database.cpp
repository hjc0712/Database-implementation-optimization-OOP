...
*/
  ...
  StatusResult Database::describe(std::ostream &anOutput) {
    DescribeDatabaseView* theDatabaseView = new DescribeDatabaseView(storage);
    theDatabaseView->show(anOutput);
    //STUDENT: do the following tasks...
    //         1. create a DescribeDatabaseView, and pass your internal storage member as an argument
    //         2. If your view was constructed correctly, call the theView->show(anOuput) to show the blocks...
    //         3. Make sure you delete any resources you allocated during this process
    delete theDatabaseView;
